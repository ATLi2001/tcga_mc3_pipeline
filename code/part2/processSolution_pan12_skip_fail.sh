...
for SAMPLE in $(cat $JOBS); do
    ...
    gsutil cp gs://bucket1q2w/phylowgs_mc3/pan12/titancna_res/${SAMPLE}/optimalClusterSolution.txt phylowgs_input/${SAMPLE}/ || true
	...
	gsutil cp gs://bucket1q2w/phylowgs_mc3/pan12/titancna_res/${optimal} phylowgs_input/${SAMPLE}/ || true
